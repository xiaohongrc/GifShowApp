package com.hongenit.gifshowapp.share
...
import com.hongenit.gifshowapp.util.ImageUtil
import com.hongenit.gifshowapp.util.album.AlbumActivity.Companion.REQUEST_PERMISSION_SETTING
    ...
    private fun processShare(shareType: Int) {
        handlePermissions(arrayOf(Manifest.permission.WRITE_EXTERNAL_STORAGE), object : PermissionListener {
            ...
            override fun onDenied(deniedPermissions: List<String>) {
                ...
                if (allNeverAskAgain) {
                    val dialog = AlertDialog.Builder(attachedActivity, R.style.AppAlertDialogStyle)
                            ...
                            .setPositiveButton(GlobalUtil.getString(R.string.settings)) { _, _ ->
                                ...
                                intent.data = uri
                                attachedActivity.startActivityForResult(intent, REQUEST_PERMISSION_SETTING)
                            }
