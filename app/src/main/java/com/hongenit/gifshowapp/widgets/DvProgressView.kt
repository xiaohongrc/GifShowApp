...
class DvProgressView : View {
    ...
    private fun createDvPath(): Path {
        ...
        val rightTopCorner =
            RectF((dvBodyWidth - cornerSize * 2).toFloat(), 0f, dvBodyWidth.toFloat(), (cornerSize * 2).toFloat())
        ...
        val leftBottomCorner =
            RectF(0f, (dvBodyHeight - cornerSize * 2).toFloat(), (cornerSize * 2).toFloat(), dvBodyHeight.toFloat())
