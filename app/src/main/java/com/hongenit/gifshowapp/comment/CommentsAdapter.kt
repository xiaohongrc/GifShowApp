...
import com.hongenit.gifshowapp.gifs.LoadingMoreViewHolder
...
//                        logWarn(
//                            TAG,
//                            "Delete comment failed. " + GlobalUtil.getResponseClue(response.status, response.msg)
//                        )
//                    }
//                }
//
...
//    }
    ...
    private fun getExpandMenuItems(comment: Comment): List<String> {
        ...
        if (comment.userId == UserModel.userId) {
