 ...
 * desc:
 */
class PostCommentsRequest(var feed_id: String, var content: String) : Request() {
    ...
    override fun listen(callback: Callback?) {
        inFlight(PostCommentResponse::class.java)
        setListener(callback)
    }

    private val URL = NetworkConst.BASE_URL + "comments/post_comments"
